        ...
        <header className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className={`text-sm mt-1 ${
              isDarkMode ? 'text-zinc-500' : 'text-slate-505'
            }`}>
              ...
              {selectedLogModal.logs.length > 0 ? (
                ...
                >
                  {selectedLogModal.logs.map((logItem, idx) => (
                    <div 
                      key={idx}
                      className={`snap-center shrink-0 w-[420px] max-w-[85vw] max-h-[70vh] flex flex-col p-6 rounded-xl border shadow-xl overflow-y-auto transition-all duration-300 ${
                        isDarkMode 
                    ...
                    >
                      ...
                      {/* Brought pageContent here to display the text body inside daily popup cards */}
                      {logItem.pageContent && (
                        <div 
                          className={`text-xs leading-relaxed p-3 rounded-lg border whitespace-pre-wrap font-medium break-words mt-auto ${
                            isDarkMode 
